...
def check_signal():
    ...
    fp=open('output_rsi_oversold/STOCKS_'+str(today)+'.txt','w')
...
def check_rsi(rsi):
	...
	Trial 8th Jun: RSI under 30 (oversold and about to bounce back)
    '''
    return  rsi[-1]<=35 and non_decreasing(rsi[-2:])
